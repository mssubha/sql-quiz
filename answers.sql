...
AND region in ('Northwest','Southwest');
...
SELECT melon_type, common_name, price, price * 0.73 AS europrice
FROM melons;
...
SELECT SUM(order_total) AS TOTAL_COST 
FROM orders;
...
SELECT MIN(order_total) AS MIN_COST 
FROM orders;
...
AND customers.email = 'pclark74@gmail.com';
